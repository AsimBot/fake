...
ua = requests.get('https://raw.githubusercontent.com/Dapunta/premium/main/data/useragent.txt').text.strip()
ua2 = requests.get('https://raw.githubusercontent.com/Dapunta/premium/main/data/useragent2.txt').text.strip()
